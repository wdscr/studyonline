...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		...
		<link rel="stylesheet" href="/studyonline//studyonline/resources/assets/css/jquery-ui-1.10.3.custom.min.css" />
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul id="nav" class="nav nav-list">
					...
					<li class="active"><a href="admin.jsp"> <i class="icon-group"></i>
					...
					<div class="row box" style="display: block;">
						<div class="col-xs-12" style="margin-top: 10px;">
							...
							<div class="row" style="margin: 0px; margin-top: 10px;">
								...
								<a href="http://localhost:8080/studyonline/DownLoad/downloadDataModel/user"><button class="btn btn-success">下载数据模板</button></a>
							</div>
						</div>
							...
							<div class="col-sm-12 col-md-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input type="text"  name="dept1" id="form-dept" placeholder=""
											class="col-xs-10 col-sm-11">
							...
							<div class="col-sm-12 col-md-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<div class="col-xs-10 col-sm-11" style="padding: 0px;">
											<textarea  name="userinfo2"	 class="form-control" id="form-userinfo2"
							...
							<div class="col-sm-12 col-md-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input  name="nickname2"	  type="text" id="form-nickname2" placeholder=""
											class="col-xs-10 col-sm-11">
							...
							<div class="col-sm-12 col-md-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input name="dept2"	  type="text" id="form-dept2" placeholder=""
											class="col-xs-10 col-sm-11">
							...
							<div class="col-sm-12 col-md-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input  name="cardnum2"	  type="text" id="form-cardnum2" placeholder=""
											class="col-xs-10 col-sm-11">
							...
							<div class="col-sm-12 col-md-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input name="phone2"	  type="text" id="form-phone2" placeholder=""
											class="col-xs-10 col-sm-11">
						...
						<div class="row" style="padding-top: 15px;">
							<div class="col-sm-12 col-md-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="col-xs-10 col-sm-11" style="padding: 0px;">
											<input  name="file2"	 type="file" id="form-file-input2" class="file-input" />
										</div>
									</div>
									...
									<div class="col-sm-9">
										<div class="col-xs-10 col-sm-11" style="padding: 0px;">
											<div class="input-group">
												...
												<input  name="date2"	 class="form-control date-picker"
...
<script type="text/javascript" src="h/studyonline/resources/js/toastr.min.js"></script> 
<link href="/studyonline/resources/css/toastr.css" rel="stylesheet">
	...
	<script>
			$(function() {
				...
				$.ajax({
					type:"get",
					url: basePath+"/userManger/findAllUser",
					dataType:"json",
					...
					success:function(data){
						...
						$.each(data, function(n, json){
							...
							+'<td>'+json.username+'</td><td>'+json.password+'</td><td>'+json.nickname+'</td><td>'+json.userinfo+'</td><td>'+json.pic+'</td>'
							+'<td>'+json.dept+'</td><td>'+json.cardnum+'</td><td>'+json.sex+'</td><td>'+json.phone+'</td><td ">'
		...
		function delUser(username){
				...
				$.ajax({
					type : "post",
					url : basePath + "/userManger/delUser",
					async:false,
					data : {
						username : username
					},
			...
			function delSelectUser() {
				...
				$.ajax({
					type : "post",
					url : basePath + "/userManger/delSelectUser",
					dataType : "text",
					data : {
			...
			function addUser() {
				...
				$("#form-addUser").ajaxSubmit({
					type : "post",
					url : basePath + "/userManger/addUser2",
					dataType : "text",
					success : function(msg) {
			...
			function addUserByFile() {
				...
				$("#file-input3").ajaxSubmit({
					type : "post",
					url : basePath + "/userManger/addUserByFile",
					dataType : "text",
					success : function(msg) {
						window.location.reload();
					}
