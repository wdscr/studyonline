...
<!--     	<div class="search-index-bar">
	    	...
	    	<div  class="contont-left" style="display: inline-block; min-width: 790px;" > 
		    	     <div class="tab-pane fade in " id="course-message-pane">
	                    <div class="row message">
	                        <div class="col-md-12">
	                            
	                                <div class="message-tool">
	                                    <div class="tool-left" style="display: inline-block; vertical-align: bottom; height: 50px;width:500px">
	                                        <div class="search-condition">              
	                                            <ul class="navbar-nav nav">                      
	                                                <li class="active"><a href="question.jsp">全部</a></li>
	                                                <!-- <li><a href="#">精华</a></li> -->
	                                            </ul>
	                                        </div>  
	                                    </div>
	    		            ...
	    		            <div class="content-right" style="display: inline-block;float: right; min-width: 290px;">
                ...
                <div class="related-question" style="padding: 10px; border-bottom: solid #cccccc 1px;">
                    <div class="related-question-title" style="text-align: center;">
                        <h4 style="font-weight: bold;">热门问题</h4>
                    </div>
                ...
                <div class="related-question-content" >
															...
															<div class="profile-activity clearfix">
																...
																<div>
																	...
																	<div class="zzmessage">
																		<a href="DownLoad/downloadFile/${course.id}" class="pull-left answer-nun">100   回答</a>
																			<a href="DownLoad/downloadFile/${course.id}" class="pull-right answer-nun"> 来自 PHP</a>
															       </div>
																...
																<div>
																	<div class="hottitle">
																	  <a href="postManager/clickReply/2">444</a>
																	</div>
																	
																	<div class="zzmessage">
																		<a href="javascript:void(0)" class="pull-left answer-nun">100   回答</a>
																			<a href="javascript:void(0)" class="pull-right answer-nun"> 来自 PHP</a>
															       </div>
  ...
  function count(searchstr){
	   $.ajax({
			type:"post",
			url:basePath+"/postManager/countPost",
			dataType:"json",
			data:{
				search:searchstr
			},
			success:function(length){
				var x=0;
				if(length!=0) x=Math.ceil(length/7);
    		    $("#page").Page({
...
function turnto(a,b,d){
	 $.ajax({
		type:"post",
		url:basePath+"/postManager/findAllPost3",
		dataType:"json",
		data:{
       		  start:a,
		           pre:b,
