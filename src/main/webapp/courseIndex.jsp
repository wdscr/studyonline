                            ...
                            <li style="padding-top: 5px; display:list-item;">
                                <form action="" class="navbar-form input-group ">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-sm" id="search-btn1"  type="button"><span class="glyphicon glyphicon-search"></span>
                                            </button>
                                        </span>
                                    </div>
                                </form>
    ...
    <div id="main">
    	<div class="search-index-bar">
	    	<div class="course-nav-box container">
	    		<div class="course-nav-row-dir" style="width:1140px;">
		    		<div class="coures-nav-title" style="display: inline-block;vertical-align:top;padding: 10px 15px;">
		    			<span><strong>方向：</strong></span>
		    		</div>
		    		<div class="course-nav-class" style="display: inline-block;vertical-align:top;width: 1050px;">
		    			<ul class="nav nav-pills" id="class1">
		    				<!-- <li class="course-nav-item active" style="display: inline-block;"  name="-1"><a href="#">全部</a></li> -->
		    				<!-- <li class="course-nav-item" style="display: inline-block;"><a href="#">前端开发</a></li>
		    				<li class="course-nav-item" style="display: inline-block;"><a href="#">后端开发</a></li>
		    				<li class="course-nav-item" style="display: inline-block;"><a href="#">移动开发</a></li>
		    				<li class="course-nav-item" style="display: inline-block;"><a href="#">数据库</a></li>
		    				<li class="course-nav-item" style="display: inline-block;"><a href="#">云计算&大数据</a></li>
		    				<li class="course-nav-item" style="display: inline-block;"><a href="#">UI设计</a></li> -->
		    			</ul>
		    		</div>
	    		</div>
	    		<div class="course-nav-row-cla" style="width:1140px;">
		    		<div class="coures-nav-title" style="display: inline-block;vertical-align:top;padding: 10px 15px;">
		    			<span><strong>分类：</strong></span>
		    		</div>
		    		<div class="course-nav-class" style="display: inline-block;vertical-align:top;width: 1050px;">
		    			<ul class="nav nav-pills"  id="class2">
                         <!--    <li class="course-nav-item active" style="display: inline-block;" name='-1'  ><a href="#">全部</a></li> -->
                        <!--    <li class="course-nav-item" style="display: inline-block;"><a href="#">HTML/CSS</a></li> -->
                           <!--<li class="course-nav-item" style="display: inline-block;"><a href="#">JavaScript</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">HTML5</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">CSS3</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">JQuery</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">Node.js</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">AngularJS</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">Bootstrap</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">React.JS</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">Vue.js</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">Sass/Less</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">WebApp</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">前端工具</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">PHP</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">Java</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">Python</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">C</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">C++</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">GO</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">C#</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">Android</a></li>
                            <li class="course-nav-item" style="display: inline-block;"><a href="#">iOS</a></li> -->
		    			</ul>
		    		</div>
	    		</div>
	    	</div>
    	...
    	<div class="course-search-list">
	    	<div class="container">
				<div class="course-tool-bar" style="padding:15px;">
					<div class="tool-left" style="display: inline-block; vertical-align: middle;">
						<div class="search-condition">				
							<ul class="nav-pills nav"  id="orderby1">						
								<li class="active"   name="otime"><a href="courseIndex.jsp?order=otime">按时间</a></li>
								<li name="oclick"><a href="courseIndex.jsp?order=oclick">按点击</a></li>
							</ul>
						</div>	
					</div>
...
/*     $.ajax({
        ...
        success:function(data){
         $.each(data, function(n, data){
               $("#class2").append("<li class='course-nav-item' style='display: inline-block;' onclick=showc('"+data.id+"') name='"+data.id+"'><a href='#'  >"+data.classname+"</a></li>");
         })
       }
})
 */
function gosec(id,forn){
/* 	   alert(id+"oooooo"+forn); */
		$("#class1 li").removeClass('active');
		$("#class1  li[name='"+id+"']").addClass('active'); 
		var Searchby3 = GetQueryString("order");
		$('#orderby1 li').removeClass('active');
		if(Searchby3!=null&&Searchby3=="oclick"){
			$('#orderby1 li[name=oclick]').addClass('active');
		}else{
			$('#orderby1 li[name=otime]').addClass('active');
		}
		var orderby=$('#orderby1 li.active').attr('name');
		var Searchby2= GetQueryString("class");
		var Searchby2id = GetQueryString("classid");
		if(Searchby2==null||Searchby2==""){
				Searchby2="";
				Searchby2id=-1;
		}
		if(id==-1){
		  $.ajax({
		        ...
		        dataType:"json",
		        success:function(data){
		        	  $("#class2").append("<li class='course-nav-item' style='display: inline-block;'  name='-1'><a href='courseIndex.jsp?"+"order="+orderby+"'>全部</a></li>");
		         $.each(data, function(n, data){
		               $("#class2").append("<li class='course-nav-item' style='display: inline-block;'  name='"+data.id+"'><a href='courseIndex.jsp?class="+data.classname+ "&classid="+data.id+"&order="+orderby+"'>"+data.classname+"</a></li>");
		         })
		         $("#class2  li").removeClass('active'); 
				  $("#class2  li[name="+Searchby2id+"]").addClass('active'); 
		          var x2=$('#class2 li.active a').text();
		          if(Searchby2id==-1)  x2="";
				  count("",x2,orderby);
				  turnto(0,15,"",x2,orderby); 
		       }
		})
		  return ;
		}
		   ...
		   $.ajax({
        		...
        		success:function(data2){
        			  $("#class2").append("<li class='course-nav-item' style='display: inline-block;'  name='-1'><a href='courseIndex.jsp?for="+forn+"&forid="+id+"&order="+orderby+"'>全部</a></li>");
        			$.each(data2, function(n, data2){
        				  $("#class2").append("<li class='course-nav-item' style='display: inline-block;'  name='"+data2.id+"'><a href='courseIndex.jsp?for="+forn+"&forid="+id+"&class="+data2.classname+ "&classid="+data2.id+"&order="+orderby+"'>"+data2.classname+"</a></li>");
        			})
                	$("#class2  li").removeClass('active');
                	$("#class2  li[name="+Searchby2id+"]").addClass('active'); 
                	var x2=$('#class2 li.active a').text();
        			if(Searchby2id==-1)  x2="";
                     count($('#class1 li.active a').text(),x2,orderby);
        			 turnto(0,15,$('#class1 li.active a').text(),x2,orderby); 
        		}
        	})
}
...
/* 	function showc(id){
		var a=0,b=15,c="",d="";
	 	$("#class2 li").removeClass('active');
		$("#class2  li[name='"+id+"']").addClass('active'); 
		var t2=id;
		var t1=$('#class1 li.active').attr('name');
		if(t1!=-1)  c=$('#class1 li.active a').text();
		if(t2!=-1)  d=$('#class2 li.active a').text();
		var orderby=$('#orderby1 li.active').attr('name');
	    location.href= basePath+'/courseIndex.jsp?for='+c+'?class='+d+'?order='+orderby;
		count(c,d);
		turnto(a,b,c,d) 
	} */
	
	function count(f,s,oby){
		   /* alert("f:"+f+"s:"+s); */
		   $.ajax({
     		type:"post",
     		url: basePath +"/courseManger/countCourse",
     		dataType:"text",
     		data:{
     			f:f,
     			s:s
	...
	function turnto(a,b,c,d,e){
		 $.ajax({
     		type:"post",
     		url: basePath +"/courseManger/findCourselimt2",
     		dataType:"json", 
     		data:{
	        		   start:a,
			           pre:b,
     		...
     		success:function(data2){
     			...
     			$.each(data2, function(n, data2){
     	             ...
     	             html+="<a target='_blank' href='student/CourseInfo/"+data2.id+"'>";
     			...
     			if(html=="") html="<center>暂无课程</center>";
     			$('#allc').html(html);
...
$(function(){  
	$.ajax({
        ...
        success:function(data){
    		...
    		var orderby=$('#orderby1 li.active').attr('name');
        	  $("#class1").append("<li class='course-nav-item' style='display: inline-block;'  name='-1'><a href='courseIndex.jsp?order="+orderby+"'>全部</a></li>");
         $.each(data, function(n, data){
               $("#class1").append("<li class='course-nav-item' style='display: inline-block;'  name='"+data.id+"'><a href='courseIndex.jsp?for="+data.classname+  "&forid="+data.id+"&order="+orderby+"'>"+data.classname+"</a></li>");
         })
     	var Searchby1 = GetQueryString("for");
     	var Searchby1id = GetQueryString("forid");

     	if(Searchby1==null||Searchby1==""){
     		Searchby1="";
     		Searchby1id=-1;
     	}
     	gosec(Searchby1id,Searchby1);
       }
    })
	...
	if(Searchby3==null||Searchby3=="")
		Searchby3=""; */
	
/*     turnto(0,15,Searchby1,Searchby2,Searchby3);
    count(Searchby1,Searchby2,Searchby3); */
	var xx="${identify}";
