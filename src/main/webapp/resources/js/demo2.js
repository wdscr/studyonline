...
var reply = function (param) {
    var list = document.getElementById('list-reply');
    ...
    function reply(box, el) {
		...
		if(textarea.placeholder!="评论..."){
			textarea.value=textarea.placeholder+textarea.value;
		}
        commentBox.setAttribute('user', 'self');
        commentBox.innerHTML =
            '<img class="myhead img-circle" src="/studyonline/'+param.pic+'" alt=""/>' +
                '<div class="comment-content">' +
                '<p class="comment-text"><span class="user">'+param.name+'：</span>' + textarea.value + '</p>' +
